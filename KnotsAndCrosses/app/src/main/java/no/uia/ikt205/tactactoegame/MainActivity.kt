...
import no.uia.ikt205.tactactoegame.dialogs.CreateGameDialog
import no.uia.ikt205.tactactoegame.dialogs.GameDialogListener
import no.uia.ikt205.tactactoegame.dialogs.JoinGameDialog
...
class MainActivity : AppCompatActivity() , GameDialogListener {
    ...
    private fun createSingleGame() {
        GameManager.createGame("Single_Player")
        val intent = Intent(this, SinglePlayerActivity::class.java).apply {
            putExtra(EXTRA_MESSAGE, "Single_Player")
        }
